...
import { User, Settings, Gift, MessageCircle, Users, ChevronRight, Edit3 } from "lucide-react";
...
export function ProfilePage() {
  ...
  const handleReferFriend = () => {
    ...
    toast({
      title: "Link kopiert",
      description: "Teilen Sie den Link mit Freunden und erhalten Sie beide 5€ Guthaben!",
    });
  };
    ...
    <div className="space-y-6 pb-20">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <Card>
          <CardContent className="p-4">
            <div className="text-center">
              <div className="text-2xl font-bold text-primary">{(walletBalance.balance / 100).toFixed(0)}€</div>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm text-muted-foreground">Beide erhalten 5€ Guthaben</div>
                </div>
              </div>
              <ChevronRight className="h-4 w-4 text-muted-foreground" />
            </motion.button>
